      ...
      <Popover>
        ...
        >
          <Button
            variant="outline"
            className={cn(
              'mb-[2px] flex h-auto w-full flex-row items-center justify-start bg-popover px-4 py-2 text-start even:border-r-[1px]  lg:mb-0',
          ...
          >
            ...
            <CalendarIcon className="ml-auto hidden h-5 w-5 text-secondary lg:block" />
          </Button>
        </PopoverTrigger>
