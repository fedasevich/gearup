...
function DropdownCalendar({ className, classNames, showOutsideDays = true, ...props }: CalendarProps) {
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_month: 'relative inline-flex items-center  [&_option]:text-black dark:[&_option]:text-black',
        dropdown_year: 'relative inline-flex items-center [&_option]:text-black dark:[&_option]:text-black',
